...
> ا <span style="color:#D97706; font-weight:bold;">الفكرة:</span> تشغيل عدة نسخ (instances) من Claude Code على فروع مختلفة تعمل على ميزات متعددة في آنٍ واحد، لتصبح «وحش إنتاجية».
